  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto select-none font-sans pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#13493B]/10 pb-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#07221A] text-[#20E79A] border border-[#20E79A]/30 text-[10px] font-black uppercase tracking-wider mb-1 shadow-xs">
            <Radio className="w-3 h-3 text-[#20E79A]" /> Admin Device Management
          </div>
          ...
          <div className="glass-card bg-white/95 rounded-[28px] sm:rounded-[36px] p-5 sm:p-8 border border-[#13493B]/10 shadow-[0_16px_40px_-8px_rgba(7,34,26,0.08),0_4px_12px_rgba(0,0,0,0.03)] relative overflow-hidden space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#F4F7F6] pb-5">
              <div className="space-y-1">
                <span className="text-[10px] font-black uppercase tracking-wider text-emerald-800 bg-emerald-100/90 px-2.5 py-1 rounded-full border border-emerald-300 inline-flex items-center gap-1.5 shadow-xs">
            ...
            {/* Status Floating Grid: ESP32, Wi-Fi, Firebase, Last Response */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              {/* Last Response Date & Timestamp Card */}
              <motion.div 
                whileHover={{ y: -3, scale: 1.02 }}
                transition={{ type: "spring", stiffness: 350, damping: 20 }}
                className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-gradient-to-b from-[#EBFBF4] to-[#E2F7ED] border border-[#20E79A]/30 shadow-sm hover:shadow-md transition-all flex items-center gap-3.5"
              >
                <div className="w-11 h-11 rounded-2xl bg-white text-[#13493B] border border-[#20E79A]/30 flex items-center justify-center shrink-0 shadow-sm">
                  <Clock className="w-5 h-5 text-[#20E79A]" />
                </div>
                <div className="min-w-0">
                  <span className="text-[10px] font-extrabold uppercase text-[#13493B] block truncate">Last Response</span>
                  <div className="mt-0.5">
                    <span className="text-xs font-black text-[#07221A] block truncate">{formattedResponseDate}</span>
                    <span className="text-[10px] font-mono font-bold text-[#5C7F75] block truncate">{formattedResponseTime}</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-mono font-bold text-[#07221A] bg-[#EBFBF4] px-2.5 py-1 rounded-full border border-[#20E79A]/30 flex items-center gap-1.5 shadow-xs">
                    <Clock className="w-3 h-3 text-[#20E79A]" />
                    <span className="text-[#5C7F75]">Last Response:</span>
                    <span>{formattedResponseDate}, {formattedResponseTime}</span>
                  </span>
            ...
            <div className="border-t border-[#13493B]/10 pt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  ...
                  <span className="tracking-wide">CHANGE WI-FI</span>
                </motion.button>
                ...
                <motion.button
                  ...
                  className="px-6 py-3.5 rounded-2xl bg-[#07221A] hover:bg-[#134336] border border-[#20E79A]/40 text-white font-black text-xs flex items-center justify-center gap-2 cursor-pointer flex-1 shadow-md hover:shadow-lg transition-all min-h-[44px]"
                >
                  <Sliders className="w-4 h-4 text-[#20E79A]" />
                  <span className="tracking-wide">CONFIGURE THRESHOLDS</span>
                </motion.button>
              </div>
            </div>
          </div>
      ...
      {/* SMART IOT EDGE NODE REGISTRATION MODAL WITH ANIMATED RADAR & AI CALIBRATION */}
      <SmartDeviceRegistrationModal
